...
public class TheradLocalChallenge {
    ...
    public static void main(String... doYourBest) throws InterruptedException {
        ...
        startJoinThread(new MarvelThreadLocal("Cyclps", false));
    }

    public static void startJoinThread(MarvelThreadLocal marvelThreadLocal) throws InterruptedException {
    ...
    static class MarvelThreadLocal extends Thread {
        ...
        public MarvelThreadLocal(String name, boolean canBeatMagneto) {
            xmanName.set(name);
